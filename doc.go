...
capnpc-go provides the compiler backend for capnp.
	...
	go install github.com/kentik/go-capnproto2/capnpc-go
	# Then, generate Go files.
	capnp compile -I$GOPATH/src/github.com/kentik/go-capnproto2/std -ogo *.capnp
...
detect when two types are in the same package.  For example:
	...
	$Go.package("main");
	$Go.import("github.com/kentik/go-capnproto2/example");
...
*/
package capnp // import "github.com/kentik/go-capnproto2"
